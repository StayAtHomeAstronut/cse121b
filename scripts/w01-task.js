// 🔍 Part 1 error
let userName = "Moroni"; //changed constant to let to enable userName to be changed.
console.log(`Username: ${userName}`);
userName = "Moronihah";
console.log(`Username: ${userName}`);

// 🔍 Part 2 error
const currentDateAndTime = Date(); //datetime was not defined, changed JS reference to current datetime
...
console.log(`The total is ${theTotal}`); //should log 55, not 45
